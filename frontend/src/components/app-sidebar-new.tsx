...
export function AppSidebar() {
  ...
  const getNavigationItems = (): NavigationItem[] => {
    ...
    if (hasReadUsers) {
      ...
      if (hasReadUsers)
        userSubItems.push({ title: "All Users", url: "/dashboard/users" });
      if (hasCreateUsers)
        userSubItems.push({ title: "Add User", url: "/dashboard/users/add" });
      if (hasReadRoles)
        userSubItems.push({ title: "User Roles", url: "/dashboard/roles" });
    ...
    if (hasReadBooks) {
      ...
      if (hasReadBooks)
        bookSubItems.push({ title: "All Books", url: "/dashboard/books" });
      if (hasCreateBooks)
        bookSubItems.push({ title: "Add Book", url: "/dashboard/books/add" });
      if (hasReadBooks)
        bookSubItems.push({
          title: "Categories",
